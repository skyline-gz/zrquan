json.imageActionName 'upload_image'
json.imageAllowFiles ['.png', '.jpg', '.jpeg', '.gif', '.bmp']
json.imageCompressBorder 1600
...
json.imageManagerListSize 20
json.imageManagerUrlPrefix ''
json.imageMaxSize 2048000
json.imagePathFormat '/server/ueditor/upload/image/{yyyy}{mm}{dd}/{time}{rand:6}'
json.imageUrlPrefix ''
...
json.fileManagerUrlPrefix ''
json.fileMaxSize 2048000
json.filePathFormat '/server/ueditor/upload/file/{yyyy}{mm}{dd}/{time}{rand:6}'
json.fileUrlPrefix ''